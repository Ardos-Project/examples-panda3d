...
localconfig = f"air-base-channel {int(os.getenv('AIR_BASE_CHANNEL', '400000000'))}\n"
localconfig += (
...
from openworld.uberdog.OpenWorldUberRepository import OpenWorldUberRepository

simbase.air = OpenWorldUberRepository(
